...
@section("content")
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p><strong>Phone:</strong> +237 650729916 (Placeholder)</p>
                            <hr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="Java, Python, SQL, Web Development (HTML, CSS, JS)">
                        </div>
                        <div class="form-group">
                            <label>Status</label>
    ...
    <div class="modal fade" id="confirmUserActionModal" tabindex="-1" role="dialog"
        aria-labelledby="confirmUserActionModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to <span id="user-action-type">[block/unblock]</span> the user: <strong
                        id="user-action-name">[User Name]</strong>?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
