...
<div class="content-header">
    <div class="container-fluid">
       <div class="row mb-2">
          <div class="col-sm-6">
             <h1 class="m-0"><img src="../asset/img/complaint.png" width="40">Ca Complaints</h1>
          </div>
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Ca Complaints</li>
             </ol>
          </div><br>
       </div>
    </div>
...
<section class="content">
             ...
             <table id="example1" class="table">
                ...
                <tbody>
                            ...
                            @if ($complaint->category == 'ca')
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-info" href="#" data-toggle="modal" data-target="#viewComplaint{{ $course->id.$complaint->id }}"><i
                   ...
                   {{-- <tr>
                      <td>CMPLT-456</td>
                      <td>
                         <p class="info"><small class="text-danger">Stakeholder Name:</small>Adrew Sy</p>
                         <p class="info"><small class="text-danger">Concern:</small> Concern 2</p>
                         <p class="info"><small class="text-danger">Department:</small> Department 2</p>
                         <p class="info"><small class="text-danger">Timestamp:</small> 06-28-2021</p>
                      </td>
                      ...
                      <td class="text-center">
                         <a class="btn btn-sm btn-success" href="#"><i
                               class="fa fa-thumbs-up"></i> approve</a>

                         <a class="btn btn-sm btn-danger" href="#"><i
                            class="fa fa-thumbs-down"></i> decline</a>

                         <a class="btn btn-sm btn-info" href="#" data-toggle="modal" data-target="#details"><i
                            class="fa fa-eye"></i> view</a>
                      </td>
                   </tr> --}}
                </tbody>
    ...
    @foreach ($courses as $course)
        @foreach ($course->complaints as $complaint)
            @if ($complaint->category == 'ca')
                <div id="viewComplaint{{ $course->id.$complaint->id }}" class="modal animated rubberBand delete-modal" role="dialog">
