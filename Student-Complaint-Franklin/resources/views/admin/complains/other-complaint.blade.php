...
<div class="content-header">
    <div class="container-fluid">
       <div class="row mb-2">
          <div class="col-sm-6">
             <h1 class="m-0"><img src="../asset/img/complaint.png" width="40">Other Complaints</h1>
          </div>
          <div class="col-sm-6">
                        ...
                        @if($complaint->course->department->id == $id)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span class="badge {{ $badgeClass }}">pending</span>
                                </td>
                                <td class="text-center">
                                    <a class="btn btn-sm btn-success" href="#" data-toggle="modal" data-target="#decline{{ $complaint->id }}"><i
